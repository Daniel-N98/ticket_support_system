...
export default function NavBar() {
  ...
  return (
    <aside className="w-full md:w-64 bg-main-secondary px-6 py-4 md:py-9 flex flex-col border-b border-white/30 md:border-0 md:h-screen md:fixed md:left-0 md:top0">
